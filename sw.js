...
const CACHE='imperio-v7';
const ASSETS=['./','./index.html','./engine.js?v=7','./ui.js?v=7',
  './data/concepts.js?v=7','./data/sales.js?v=7','./data/people.js?v=7','./data/world.js?v=7','./data/misiones.js?v=7',
  './oficina.js?v=7','./manifest.json'];
